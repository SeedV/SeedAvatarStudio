...
namespace SeedUnityVRKit {
  ...
  public class HandLandmarksController : MonoBehaviour {
    ...
    public Quaternion InitRotation = Quaternion.Euler(0, -90, -90);
    ...
    async void Update() {
      if (HandLandmarkList != null) {
        ...
        _fingerTargets[3].rotation = Quaternion.LookRotation(new Vector3(-_fingerDirections[3].x, _fingerDirections[3].y, _fingerDirections[3].z)) * Quaternion.Euler(90, 0, 0);
        _fingerDirections[4] = _handLandmarks[7].transform.position - _handLandmarks[6].transform.position;
        _fingerTargets[4].rotation = Quaternion.LookRotation(new Vector3(-_fingerDirections[4].x, _fingerDirections[4].y, _fingerDirections[4].z)) * Quaternion.Euler(90, 0, 0);
        _fingerDirections[5] = _handLandmarks[8].transform.position - _handLandmarks[7].transform.position;
        _fingerTargets[5].rotation = Quaternion.LookRotation(new Vector3(-_fingerDirections[5].x, _fingerDirections[5].y, _fingerDirections[5].z)) * Quaternion.Euler(90, 0, 0);

        _fingerDirections[6] = _handLandmarks[10].transform.position - _handLandmarks[9].transform.position;
        _fingerTargets[6].rotation = Quaternion.LookRotation(new Vector3(-_fingerDirections[6].x, _fingerDirections[6].y, _fingerDirections[6].z)) * Quaternion.Euler(90, 0, 0);
        _fingerDirections[7] = _handLandmarks[11].transform.position - _handLandmarks[10].transform.position;
        _fingerTargets[7].rotation = Quaternion.LookRotation(new Vector3(-_fingerDirections[7].x, _fingerDirections[7].y, _fingerDirections[7].z)) * Quaternion.Euler(90, 0, 0);
        _fingerDirections[8] = _handLandmarks[12].transform.position - _handLandmarks[11].transform.position;
        _fingerTargets[8].rotation = Quaternion.LookRotation(new Vector3(-_fingerDirections[8].x, _fingerDirections[8].y, _fingerDirections[8].z)) * Quaternion.Euler(90, 0, 0);

        _fingerDirections[9] = _handLandmarks[14].transform.position - _handLandmarks[13].transform.position;
        _fingerTargets[9].rotation = Quaternion.LookRotation(new Vector3(-_fingerDirections[9].x, _fingerDirections[9].y, _fingerDirections[9].z)) * Quaternion.Euler(90, 0, 0);
        _fingerDirections[10] = _handLandmarks[15].transform.position - _handLandmarks[14].transform.position;
        _fingerTargets[10].rotation = Quaternion.LookRotation(new Vector3(-_fingerDirections[10].x, _fingerDirections[10].y, _fingerDirections[10].z)) * Quaternion.Euler(90, 0, 0);
        _fingerDirections[11] = _handLandmarks[16].transform.position - _handLandmarks[15].transform.position;
        _fingerTargets[11].rotation = Quaternion.LookRotation(new Vector3(-_fingerDirections[11].x, _fingerDirections[11].y, _fingerDirections[11].z)) * Quaternion.Euler(90, 0, 0);

        _fingerDirections[12] = _handLandmarks[18].transform.position - _handLandmarks[17].transform.position;
        _fingerTargets[12].rotation = Quaternion.LookRotation(new Vector3(-_fingerDirections[12].x, _fingerDirections[12].y, _fingerDirections[12].z)) * Quaternion.Euler(90, 0, 0);
        _fingerDirections[13] = _handLandmarks[19].transform.position - _handLandmarks[18].transform.position;
        _fingerTargets[13].rotation = Quaternion.LookRotation(new Vector3(-_fingerDirections[13].x, _fingerDirections[13].y, _fingerDirections[13].z)) * Quaternion.Euler(90, 0, 0);
        _fingerDirections[14] = _handLandmarks[20].transform.position - _handLandmarks[19].transform.position;
        _fingerTargets[14].rotation = Quaternion.LookRotation(new Vector3(-_fingerDirections[14].x, _fingerDirections[14].y, _fingerDirections[14].z)) * Quaternion.Euler(90, 0, 0);
